   ...
   <div class="row">
	   <div class="col-md-12 col-lg-8 mb-5" style="margin-top:15px;">
			...
			<?endforeach?>
				...
				<div class="row form-group">
					<div class="col-md-12">
						<input type="submit" class="btn btn-primary py-2 px-4 rounded-0" name="Login" value="<?=GetMessage("AUTH_LOGIN_BUTTON")?>" />
					</div>
				</div>
				...
				<?if($arResult["AUTH_SERVICES"]):?>
					<div class="row form-group">
						<div class="col-md-12 mb-3 mb-md-0">
							  <label class="font-weight-bold" for="socserv"><?=GetMessage("socserv_as_user_form")?></label>
							  <?
