	...
	<?=bitrix_sessid_post()?>
			<div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" name="user_name" class="form-control" value="<?=$arResult["AUTHOR_NAME"]?>" placeholder="Full Name">
                </div>
             </div>
             <div class="row form-group">
                <div class="col-md-12">
                  <label class="font-weight-bold" for="email"><?=GetMessage("MFT_EMAIL")?></label>
                  <input type="email" name="user_email" id="email" value="<?=$arResult["AUTHOR_EMAIL"]?>" class="form-control" placeholder="Email Address">
                </div>
             </div>
             <div class="row form-group">
                <div class="col-md-12">
